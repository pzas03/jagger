...
public class TestDefinitionParser extends CustomBeanDefinitionParser {
    ...
    protected void parse(Element element, ParserContext parserContext, BeanDefinitionBuilder builder) {
        ...
        setBeanProperty(XMLConstants.DECISION_MAKER_LISTENER ,DomUtils.getChildElementByTagName(element,XMLConstants.TEST_GROUP_DECISION_MAKER_LISTENER),parserContext,builder.getBeanDefinition());
    }
