...
public class XMLConstants {
    ...
    public static final String TEST_GROUP_DECISION_MAKER_LISTENER = "listener-test-group-decision-maker";
    public static final String DECISION_MAKER_LISTENER = "testGroupDecisionMakerListener";
