...
*/
public class NewJaggerConfigurationTest {
    ...
    public void testInit() throws Exception{
        ...
        URL directory = new URL("file:"+ "/home/evelina/work/JaggerRepo/jagger/chassis/configuration/");
        Properties environmentProperties = new Properties();
        JaggerLauncher.loadBootProperties(directory, "profiles/local/environment.properties", environmentProperties);
        environmentProperties.put("chassis.master.configuration.include",environmentProperties.get("chassis.master.configuration.include")+", ../spring.schema/src/test/resources/example-new-test-configuration.xml1");
